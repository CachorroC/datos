...
exports.UltimaActuacionSchema = z.object({
  ...
  actuacion: z.string(),
  anotacion: z.union([z.null(), z.string()]),
...
exports.TelSchema = z.object({
  fijo: z.union([z.coerce.number(), z.null()]),
...
exports.DemandaSchema = z.object({
  ...
  etapaProcesal: z.union([z.null(), z.string()]),
...
function idkCarpetas() {
  for (const carpeta of zod_carpetas_1.ZodCarpetas) {
    const parser =
      exports.IntCarpetaElementSchema.parse(
        carpeta
      );
    console.log(parser);
    fs.writeFile(
      `carpetas/${carpeta._id}.json`,
