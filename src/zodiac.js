...
exports.idkCarpetas = exports.IntCarpetaElementSchema = exports.DemandaSchema = exports.DepartamentoSchema = exports.JuzgadoSchema = exports.DeudorSchema = exports.TelSchema = exports.UltimaActuacionSchema = exports.CodReglaSchema = exports.TipoProcesoSchema = exports.DescripcionSchema = exports.CategorySchema = void 0;
const zod_carpetas_1 = require("./data/zod-carpetas");
...
exports.DemandaSchema = z.object({
    ...
    municipio: z.string(),
    obligacion: z.record(z.coerce.string(), z.union([
        z.number(),
        z.string()
    ])),
    radicado: z.string(),
    ...
    expediente: z.string(),
    juzgados: z.array(exports.JuzgadoSchema)
});
...
function idkCarpetas() {
    for (const carpeta of zod_carpetas_1.ZodCarpetas) {
        const parser = exports.IntCarpetaElementSchema.parse(carpeta);
        console.log(parser);
        fs.writeFile(`carpetas/${carpeta._id}.json`, JSON.stringify(parser));
    }
}
exports.idkCarpetas = idkCarpetas;
console.log(idkCarpetas());
