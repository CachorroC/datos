...
const mongodb_2 = __importDefault(require("../lib/mongodb"));
const carpetas = [
    {
        numero: 1,
        id: '39581581',
    ...
    },
    {
        ...
        deudor: {
            ...
            tel: {
                fijo: '',
                celular: '3108612781        CEL 3502772711'
            },
...
const carpetasCollection = async () => {
    const client = await mongodb_2.default;
    if (!client) {
...
const newCarpetas = carpetas.map((carpeta) => {
    const newCarpeta = {
        ...carpeta,
        _id: new mongodb_1.ObjectId(carpeta.numero)
    };
    return newCarpeta;
});
console.log(newCarpetas);
...
async function run() {
    try {
        ...
        const result = await foods.insertMany(newCarpetas, {
            ordered: true
        });
