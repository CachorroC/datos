import { fetchProceso } from '#@/Procesos/index.js';
import { IntCarpeta, Demanda, Juzgado, Deudor } from '#@/types/carpetas.js';
import { IntCarpetaRaw } from '#@/types/raw-carpets.js';
...
export async function updt( carpeta: IntCarpetaFresh ) {
...
export const newCarpetasMap = new Map();
