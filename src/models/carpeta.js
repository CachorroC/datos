...
class Carpeta {
    ...
    constructor({ llaveProceso, category, deudor, demanda, numero }, RequestProcesos) {
        ...
        if (RequestProcesos) {
            this.idProcesos = RequestProcesos.map((proceso) => {
                return proceso.idProceso;
            });
            this.demanda = new demanda_1.Demanda(demanda, llaveProceso, RequestProcesos);
        }
        else {
            this.demanda = new demanda_1.Demanda(demanda, llaveProceso);
        }
    }
    numero;
    cc;
